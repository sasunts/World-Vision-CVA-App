    ...
    render() {
        ...
        return (
            <View style={styles.container} >
                ...
                <Text style={{ textAlign: "center", marginTop: 150, fontSize: 25 }}>Please enter your sex:</Text>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => this.props.navigation.navigate("OccupationScreen", { sex: this.state.sex, age: params.age, name: params.name })}
                >
