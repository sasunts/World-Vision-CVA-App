    ...
    render() {
        ...
        return (
            <View style={styles.container} >
                ...
                <Text style={{ textAlign: "center", marginTop: 150, fontSize: 25 }}>Please enter your occupation:</Text>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => this.props.navigation.navigate("InformationScreen", { occupation: this.state.occupation, sex: params.sex, age: params.age, name: params.name })}
                >
