...
export default class Suggestions extends Component {
  ...
  renderRow({ item }) {
    return (
      <View>
        <SuggestionOverview params={item} />
        <View
          style={{
            flexDirection: "row",
    ...
    return (
      <ScrollView style={styles.commitmentHomeViewContainer}>
        {renderCreateSuggestion ? (
          <CreateSuggestion commitment={this.props.commitment} />
        ) : (
          <View style={styles.container}>
            <Text style={styles.contentHeading}>
              {this.props.commitment.title}
            </Text>
            <FlatList
              data={suggestionData}
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                this.setState({ renderCreateSuggestion: true });
              }}
            >
