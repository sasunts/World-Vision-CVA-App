...
class DialogBox extends Component {
	...
	// ensures that only numbers can be entered for age
	onChangeAge(text) {
		let newText = "";
	...
	// checks if age is being changed and renders a numeric keyboard
	inputType() {
			...
			<View>
				...
				<Dialog.Container visible={this.state.dialogVisible}>
					...
					<Dialog.Button
						label="Submit"
						onPress={() => {
							this.props.handleChange(this.state.edit),
								this.setState({ dialogVisible: false });
						}}
					/>
				</Dialog.Container>
